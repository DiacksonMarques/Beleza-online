...
public class UpdateAgendamentoCActivity extends AppCompatActivity {
    TextView tvCodAgdUp, tvDataList, tvHoraUp, tvFuncUp, tvServUp, tvValorUp, edClienteUp;
    Calendar calendar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_agendamento_c);
        ...
        tvDataList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data = new DatePickerDialog(UpdateAgendamentoCActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        tvHoraUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean is24Hours = DateFormat.is24HourFormat(UpdateAgendamentoCActivity.this);

                horad = new TimePickerDialog(UpdateAgendamentoCActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        btUpAgend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(networkInfo !=null && networkInfo.isConnected()){
                    ...
                    int id_centro_de_beleza= id_centro_de_belezag;
    ...
    private void getServico(JSONArray jsonArray){
        ...
        tiposervico.setAdapter(new ArrayAdapter<String>(UpdateAgendamentoCActivity.this, android.R.layout.simple_spinner_dropdown_item, servico));
    ...
    private void getFuncionario(JSONArray jsonArray){
        ...
        funcionarioup.setAdapter(new ArrayAdapter<String>(UpdateAgendamentoCActivity.this, android.R.layout.simple_spinner_dropdown_item, funcionarioa));
