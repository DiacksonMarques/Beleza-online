...
public class ListServicoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvServico = findViewById(R.id.lvServico);
        btCadSerLi= findViewById(R.id.btCadSerLi);
        ...
        url = "https://belezaonline2019.000webhostapp.com/getListServico.php?id_centro_de_beleza="+idg;

        getJSON(url);

        btCadSerLi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent abrecadfunc = new Intent(getBaseContext(), CadEmpresaServicoActivity.class);
    ...
    private void carregaListView(String json) throws JSONException{
        ...
        lvServico.setAdapter(arrayAdapter);

        lvServico.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final String Sele = ((TextView) view).getText().toString();
                Toast.makeText(getBaseContext(), Sele, Toast.LENGTH_LONG).show();
                AlertDialog.Builder builder = new AlertDialog.Builder(ListServicoActivity.this);
                ...
                builder.setNegativeButton("Excluir", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        url = "https://belezaonline2019.000webhostapp.com/deleteServico.php";
                        parametros ="id="+idaf;
    ...
    private class SolicitaDados extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            if(resultado != null && !resultado.isEmpty() && resultado.contains("Deletado_Ok")){
                Toast.makeText(getBaseContext(),"Serviço excluido com sucesso!",Toast.LENGTH_LONG).show();
                finish();
