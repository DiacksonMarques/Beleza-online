...
public class VeriCriMapsActivity extends AppCompatActivity {
    ...
    private  void  askForLocatonChange(){
        ...
        task.addOnSuccessListener(new OnSuccessListener<LocationSettingsResponse>() {
            ...
            public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                ...
                Intent abremaps = new Intent(getBaseContext(), MapsActivity.class);
            ...
            public void onFailure(@NonNull Exception e) {
                if(e instanceof ResolvableApiException){
                    try{
                        ...
                        resolvable.startResolutionForResult(VeriCriMapsActivity.this,REQUEST_CHECK_STTINGS);
        ...
        if(requestCode == REQUEST_CHECK_STTINGS){
            switch (resultCode){
                ...
                case Activity.RESULT_CANCELED:
                    ...
                    Intent fechamaps = new Intent(getBaseContext(), MainActivity.class);
